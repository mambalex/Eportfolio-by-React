          ...
          jobs = this.props.employerData.open_job_list.map((job) => {
            ...
            return (
              <Job
                ...
                totalCan={job.resume_list.length
                + job.first_interview_list.length
                + job.second_interview_list.length
                + job.test_list.length
                + job.offer_list.length
                + job.engaged_list.length}
              />
            );
          });
          return (
...
Jobs.propTypes = {
  ...
  employerData: PropTypes.objectOf(PropTypes.Object),
  hasError: PropTypes.bool,
  isLoading: PropTypes.bool,
  instructorData: PropTypes.objectOf(PropTypes.Object),
  instructorError: PropTypes.bool,
  instructorLoading: PropTypes.bool,
  addJobHandler: PropTypes.func,
